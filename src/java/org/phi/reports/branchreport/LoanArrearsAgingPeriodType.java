...
package org.phi.reports.branchreport;

public enum LoanArrearsAgingPeriodType {
    ONE_WEEK("1", 1, 7), //
    TWO_WEEK("2", 8, 14), //
    THREE_WEEK("3", 15, 21), //
    FOUR_WEEK("4", 22, 28), //
    ...
    private LoanArrearsAgingPeriodType(String description, Integer minDays, Integer maxDays) {
